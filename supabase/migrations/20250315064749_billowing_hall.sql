/*
  ...
  1. New Tables
    ...
    - stock_produit: Stock assignments per product
    - stocks: Available stock locations
...
INSERT INTO stocks (name, description) VALUES
  ('Stock Principal', 'Stock principal de l''entreprise'),
  ('Stock Secondaire', 'Stock secondaire et réserve'),
  ('SAV', 'Stock du service après-vente')
