        ...
        <div className="flex flex-col h-full">
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Pas de prix d'achat par numéro de série</p>
            </div>
          </button>
          ...
          <div className="bg-blue-50 p-6 rounded-lg mt-4 flex-1">
            ...
            <div className="text-sm text-blue-800 space-y-3">
              ...
              <p>Accueillera plus tard les numéros de série des produits entrant en stock</p>
            </div>
          </div>
        </div>
